...
function Dashboard() {
    ...
    const findClosestAvailableDate = async (date) => {
        const baseUrl = 'http://localhost:7000/images'; // Replace with your API URL
...
//   const closestAvailableDate = await findClosestAvailableDate(date);

//   if (closestAvailableDate && !date) {
//     setSelectedDate(date);
//     setFormattedDate(closestAvailableDate);
//   } else {
//     const earliestAvailableDate = '2023-07-03';
//     setSelectedDate(date);
//     setFormattedDate(earliestAvailableDate);
//   }
// };
